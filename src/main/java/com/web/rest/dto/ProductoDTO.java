...
public class ProductoDTO {
    ...
    @Pattern(regexp = ".*[a-zA-ZáéíóúÁÉÍÓÚñÑ].*", message = "El autor debe contener al menos una letra.") // MODIFICADO
    ...
    @Pattern(regexp = "^(https?://\\S+)\\.(jpg|jpeg|png)$", message = "URL inválida (sin espacios, con http/https, y terminar en .jpg, .jpeg o .png)") // MODIFICADO
    private String imagenUrl;
    
    @NotBlank(message = "La sinopsis es obligatoria.") 
    @Size(max = 500, message = "La sinopsis no puede exceder los 500 caracteres.")
    @Pattern(regexp = ".*[a-zA-ZáéíóúÁÉÍÓÚñÑ].*", message = "La sinopsis debe contener al menos una letra.") // AÑADIDO
