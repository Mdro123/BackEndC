        ...
        http.csrf(csrf -> csrf.disable())
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET,
                    "/api/productos/**",         // Permite /productos, /productos/id, /mas-vendidos, etc.
                    "/api/categorias/**",        // Permite /categorias, /categorias/id, etc.
                    "/api/metodos-pago/**"     // Permite /metodos-pago, /metodos-pago/id
                ).permitAll()
